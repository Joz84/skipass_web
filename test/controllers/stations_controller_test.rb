...
class StationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post stations_url, params: { station: { address: @station.address, city: @station.city, description: @station.description, latitude: @station.latitude, longitude: @station.longitude, name: @station.name, num: @station.num } }
    end
  ...
  test "should update station" do
    patch station_url(@station), params: { station: { address: @station.address, city: @station.city, description: @station.description, latitude: @station.latitude, longitude: @station.longitude, name: @station.name, num: @station.num } }
